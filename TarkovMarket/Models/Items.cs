...
public class Item
{
    ...
    [JsonProperty("bannedOnFlea")]
    public bool BannedOnFlea { get; set; }

    [JsonProperty("haveMarketData")]
    public bool HaveMarketData { get; set; }
